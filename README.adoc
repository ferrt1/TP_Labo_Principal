...
PONER IMAGEN INDICE DE MITIGACION 3
...
PONER IMAGEN DE PRUEBA SPRINT 3
...
PONER IMAGEN FUNCIONALIDAD COMPLETA 3

* Nivel de Calidad Sprint 3

PONER IMAGEN DE NIVEL DE CALIDAD SPRINT 3

* Evolución de la Prueba Sprint 3

PONER IMAGEN DE EVOLUCION DE LA PRUEBA SPRINT 3

* Burndown Chart Sprint 3

PONER IMAGEN DE BURNADOWN CHART SPRINT 3
...
PONER IMANGE DE EVOLUCION DE LA PRUEBA ACUMULADOS

* Burndown Chart Acumulado

PONER IMAGEN DE BURNADOWN CHART ACUMULADOS
