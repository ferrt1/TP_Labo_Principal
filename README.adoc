...
image::Recursos/Sprint 5/Nivel de calidad sprint 5.PNG[700,700]

* Evolución de la Prueba Sprint 5

image::Recursos/Sprint 5/evolucion de la prueba sprint 5.PNG[700,700]
...
image::Recursos/Sprint 5/Evolucion de la prueba acumulado.PNG[700,700]
...
* El total del proyecto asiende a un valor de U$S 43327. Lo cual quiere decir que se utilizo el 66,6% del presupuesto inicialmente proporcionado.

PONER IMAGEN DE COSTOS
